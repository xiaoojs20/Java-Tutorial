            ...
            if (gf.isAvail[Arrayi][Arrayj] != 0) {
                ...
                if (gf.ChooseType == 0) {
                    if (gf.turn == 1) {
                        ...
                        int idx = gf.ChessPositonList.size();
                        System.out.print(gf.name_b + ": ");
                        System.out.print(gf.ChessPositonList.get(idx - 1).Listi);
                        System.out.print(",");
                        System.out.print(gf.ChessPositonList.get(idx - 1).Listj);
                        System.out.print("\n");

                        iofunc(gf.name_b + ": ("+gf.ChessPositonList.get(idx - 1).Listi+","+
                                gf.ChessPositonList.get(idx - 1).Listj+")\n");
                        ...
                        //输出位置
                        int idx = gf.ChessPositonList.size();
                        System.out.print(gf.name_w + ": ");
                        System.out.print(gf.ChessPositonList.get(idx - 1).Listi);
                        System.out.print(",");
                        System.out.print(gf.ChessPositonList.get(idx - 1).Listj);
                        System.out.print("\n");

                        iofunc(gf.name_w + ": ("+gf.ChessPositonList.get(idx - 1).Listi+","+
                                gf.ChessPositonList.get(idx - 1).Listj+")\n");
                ...
                //PVE
                    ...
                    if (gf.turn == 1) {
                        ...
                        //输出位置
                        int idx_robot = gf.ChessPositonList.size();
                        System.out.print(gf.name_w + ": ");
                        System.out.print(gf.ChessPositonList.get(idx_robot - 1).Listi);
                        System.out.print(",");
                        System.out.print(gf.ChessPositonList.get(idx_robot - 1).Listj);
                        System.out.print("\n");
                        iofunc(gf.name_w + ": ("+gf.ChessPositonList.get(idx - 1).Listi+","+
                                gf.ChessPositonList.get(idx - 1).Listj+")\n");
